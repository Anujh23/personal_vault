        ...
        return {
            ...
            income_sheet: {
                ...
                fields: [
                    ...
                    { name: 'category', label: 'Category', type: 'select', options: ['Salary', 'Business Income', 'Rental Income', 'Investment Returns', 'Commission', 'Other Income', 'Housing', 'Food', 'Transportation', 'Utilities', 'Healthcare', 'Education', 'Entertainment', 'Shopping', 'Personal Care', 'Insurance', 'Loan EMI', 'Taxes', 'Savings', 'Other Expense'] },
                    { name: 'notes', label: 'Notes', type: 'textarea' }
                ]
            },
